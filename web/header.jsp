  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="faico clear">
        <li><a class="faicon-facebook" href="https://www.facebook.com/tax.funda2017/" target="_blank"><i class="fa fa-facebook"></i></a></li>
      <!--  <li><a class="faicon-pinterest" href="#"><i class="fa fa-pinterest"></i></a></li> -->
        <li><a class="faicon-twitter" href="#"><i class="fa fa-twitter"></i></a></li>
      <!--   <li><a class="faicon-dribble" href="#"><i class="fa fa-dribbble"></i></a></li> -->
        <li><a class="faicon-linkedin" href="#"><i class="fa fa-linkedin"></i></a></li>
        <li><a class="faicon-google-plus" href="https://plus.google.com/u/0/107145547793501709832" target="_blank"><i class="fa fa-google-plus"></i></a></li>
            </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row2" >
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      ...
      <li><a class="active" href="services.jsp">Services</a>
      ...
      <li><a  href="calc.jsp">Tax calculator</a>
       ...
       <li><a href=qa.jsp?page=1>Questionnaires</a></li>
      <li>
          <a href="sendprofile.jsp">Profile</a>
      </li>
    ...
    try
    {
       String Pann=null,Pass=null,Name=null,cat=null;
       int c=0; 
       ...
       Pass=session.getAttribute("pass").toString();
               ...
               if((Pann!=null) && (Pass!=null))
               {
                    ...
                    cat=session.getAttribute("cat").toString();
                    Userdao D=new Userdao();
                    List<User>qlist=D.QsearchAl();
                    for(User s:qlist)
                    {
                        c++;
                    }
