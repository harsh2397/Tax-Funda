<%-- 
    Document   : cala
    Created on : May 20, 2017, 1:43:04 PM
    Author     : HARSH
--%>
...
<head>
	...
	<link rel="stylesheet" href="calcss/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="calcss/calc.css"> <!-- Resource style -->
	<script src="caljs/modernizr.js"></script> <!-- Modernizr -->
...
<header>
    <h1><font color="black">Tax Calculator</font></h1>
</header>
        <div class="cd-tabs" style="top: -100px;">
	<nav>
...
<script src="caljs/jquery-2.1.1.js"></script>
<script src="caljs/main.js"></script> <!-- Resource jQuery -->
